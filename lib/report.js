module.exports = function () {
  function getReport(err, res) {
    ...
    report += '| Repository | Number of times used | Has david-dm | David-dm | David-dm Dev | \n'
    report += '|:-----------|:---------------------|:-------------|:---------|:-------------| \n'
    for (var i = 0; i < res.length; i++) {
      ...
      report += '[![devDependencies Status](https://img.shields.io/david/' + res[i].user + '/' + res[i].repo
      report += '/dev-status.svg)](https://david-dm.org/' + res[i].user + '/' + res[i].repo + '#info=devDependencies) |'
      report += '\n'
    }
    return report
  }
